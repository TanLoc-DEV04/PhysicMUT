...
fs.writeFileSync('C:/Users/Lenovo/Documents/HK252/DATN/SOURCE CODE/PhysicMUT/PhysicMUT-be/src/controllers/authController.ts', code, 'utf8');

let routeCode = fs.readFileSync('C:/Users/Lenovo/Documents/HK252/DATN/SOURCE CODE/PhysicMUT/PhysicMUT-be/src/routes/auth.ts', 'utf8');

// Remove all existing bottom exports or errant google logins
routeCode = routeCode.replace(/router\.post\('\/google',\s*googleLogin\);\s*/g, '');
routeCode = routeCode.replace(/export default router;\s*/g, '');

// Append correct sequence
routeCode += "\nrouter.post('/google', googleLogin);\n\nexport default router;\n";

fs.writeFileSync('C:/Users/Lenovo/Documents/HK252/DATN/SOURCE CODE/PhysicMUT/PhysicMUT-be/src/routes/auth.ts', routeCode, 'utf8');

console.log("File Auth rewritten.");
