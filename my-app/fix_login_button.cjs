...
const searchElement = '<Button type="primary" htmlType="submit" className="w-full bg-[#0f6cbf]">';
const replacement = searchElement + \
              Đăng nhập
            </Button>
...
\;
// find <Button ...> and replace until </Button> but keeping <Button...>
const replaceRegex = /<Button type="primary" htmlType="submit" className="w-full bg-\[\#0f6cbf\]">[\s\S]*?<\/Button>/;
