      ...
      <BrowserRouter>
        <Routes>
            ...
            <Route element={<MainLayout><Outlet /></MainLayout>}>
                ...
                <Route path="/models/:id" element={<MainModelDetail />} />
                ...
                <Route path="register" element={<div className="p-8 text-center">Trang Đăng Ký (Chưa cài đặt)</div>} />
            </Route>
            ...
            <Route element={<PrivateRoute allowedRoles={['admin', 'Admin']} />}>
                <Route path="/dashboard" element={<MainDashboard />}>
                    ...
                    <Route path="3d-models/:id" element={<AddEdit3DModel />} />
                    ...
                    <Route path="*" element={<div className="p-6">Module under construction</div>} />
                </Route>
            </Route>
