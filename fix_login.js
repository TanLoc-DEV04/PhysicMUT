...
const search = '<Button type="primary" htmlType="submit" className="w-full bg-[#0f6cbf]">';
...
\;
// replace the entire button to end button block
c = c.replace(/<Button type="primary" htmlType="submit" className="w-full bg-\[\#0f6cbf\]">[\s\S]*?<\/Button>/, replacement);
