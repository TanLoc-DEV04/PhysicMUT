...
fs.writeFileSync('src/controllers/authController.ts', code, 'utf8');

// Also fix auth.ts route positioning
let routeCode = fs.readFileSync('src/routes/auth.ts', 'utf8');
routeCode = routeCode.replace('export default router;', '');
routeCode = routeCode.replace(/router\.post\\('\\/google', googleLogin\\);/g, '');
routeCode += \"\\nrouter.post('/google', googleLogin);\\n\\nexport default router;\\n\";
fs.writeFileSync('src/routes/auth.ts', routeCode, 'utf8');